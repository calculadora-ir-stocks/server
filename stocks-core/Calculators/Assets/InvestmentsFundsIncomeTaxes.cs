...
namespace stocks_core.Calculators.Assets
{
    public class InvestmentsFundsIncomeTaxes : AverageTradedPriceCalculator, IIncomeTaxesCalculator
    {
        ...
        public void CalculateIncomeTaxesForAllMonths(List<AssetIncomeTaxes> response, string month, IEnumerable<Movement.EquitMovement> movements)
        {
            ...
            if (paysIncomeTaxes)
                objectToAddIntoResponse.TotalTaxes = (double)CalculateIncomeTaxes(swingTradeProfit, dayTradeProfit, IncomeTaxesConstants.IncomeTaxesForInvestmentsFunds);
            ...
            objectToAddIntoResponse.AssetTypeId = stocks_infrastructure.Enums.Assets.InvestmentsFunds;
