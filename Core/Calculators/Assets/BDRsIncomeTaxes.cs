    ...
    public class BDRsIncomeTaxes : ProfitCalculator, IIncomeTaxesCalculator
    {
        ...
        )
        {
            ...
            investorMovementDetails.Assets.Add(new AssetIncomeTaxes(
                month, AssetEnumHelper.GetNameByAssetType(Asset.BDRs), profit.OperationHistory)
            {
            ...
            investorMovementDetails.TickerStatusAtTheEndOfTheYear.AddRange(profit.LastTimeOperatedInTimeInterval);
        }
    }
}
