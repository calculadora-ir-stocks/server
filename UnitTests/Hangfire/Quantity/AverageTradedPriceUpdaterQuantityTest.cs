...
namespace stocks_unit_tests.Hangfire.Quantity
{
    public class AverageTradedPriceUpdaterQuantityTest : ProfitCalculator
    {
        ...
        public AverageTradedPriceUpdaterQuantityTest()
        {
        ...
        [Theory(DisplayName = "Deve obter corretamente a quantidade de ativos a serem adicionados, atualizados e removidos na carteira de um investidor nas movimentações do último mês.")]
        [MemberData(nameof(DataSet))]
        public async Task ShouldAddUpdateAndDeleteCorrectly(Core.Models.B3.Movement.Root root, List<AverageTradedPriceDto> tickersInvestorAlreadyHas, Answer answer)
        {
            ...
            var tickersToAdd = AverageTradedPriceUpdaterHelper.GetTickersToAdd(tradedTickers, tickersInvestorAlreadyHas);
